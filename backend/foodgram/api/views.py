...
class RecipeViewSet(ModelViewSet):
    ...
    def favorite(self, request, pk=None):
        return self.handle_favorite_or_cart(request=request, model_class=Favorite,
                                            error_message_post='Рецепт уже в избранном.',
                                            error_message_delete='Рецепта нет в избранном.', pk=pk)
    ...
    def shopping_cart(self, request, pk=None):
        return self.handle_favorite_or_cart(request=request, model_class=Cart,
                                            error_message_post='Рецепт уже в корзине.',
                                            error_message_delete='Рецепта нет в корзине.', pk=pk)
