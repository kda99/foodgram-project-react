...
class RecipeViewSet(ModelViewSet):
    ...
    def handle_favorite_or_cart(request, user, recipe, model_class, error_message, success_status, status):
    ...
    def favorite(self, request, pk=None):
        ...
        return self.handle_favorite_or_cart(request, user, recipe, Favorite, 'Рецепт уже в избранном.',
                                       status.HTTP_201_CREATED, status)
    ...
    def shopping_cart(self, request, pk=None):
        ...
        return self.handle_favorite_or_cart(request, user, recipe, Cart, 'Рецепт уже в корзине.', status.HTTP_201_CREATED,
                                       status)
    ...
    # def favorite_or_cart(user, recipe, model_class, error_message, success_status, request):
    #     obj = model_class.objects.filter(user=user, recipe=recipe)
    #     if request.method == 'POST':
    #         if obj.exists():
    ...
    #     user = request.user
    #     recipe = get_object_or_404(Recipe, id=pk)
    #     return self.favorite_or_cart(user, recipe, Favorite, 'Рецепт уже в избранном.', status.HTTP_201_CREATED)
    #
    # @action(
    #     detail=True,
    #     methods=('POST', 'DELETE'),
    ...
    #     user = request.user
    #     recipe = get_object_or_404(Recipe, id=pk)
    #     return self.favorite_or_cart(user, recipe, Cart, 'Рецепт уже в корзине.', status.HTTP_201_CREATED)
    @action(
        detail=False,
        methods=('GET',),
        permission_classes=(permissions.IsAuthenticated,)
